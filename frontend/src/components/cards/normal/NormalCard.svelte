<script>
    export let link="", title="", description="", handleClick;
</script>

<div on:click={handleClick} class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href={link}>
